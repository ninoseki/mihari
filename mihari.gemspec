...
Gem::Specification.new do |spec|
  ...
  unless ci_env?
    spec.add_development_dependency "lefthook", "~> 1.9.2"
  ...
  spec.add_dependency "grape-swagger", "2.1.1"
  ...
  spec.add_dependency "sentry-sidekiq", "~> 5.22.0"
  spec.add_dependency "sidekiq", "7.3.6"
