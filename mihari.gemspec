...
Gem::Specification.new do |spec|
  ...
  spec.add_development_dependency "binding_of_caller", "~> 2.0.0"
  spec.add_development_dependency "bundler", "~> 4.0.7"
  spec.add_development_dependency "capybara", "~> 3.40"
  spec.add_development_dependency "factory_bot", "~> 6.6.0"
  spec.add_development_dependency "fakefs", "~> 3.2.1"
  ...
  unless ci_env?
    spec.add_development_dependency "lefthook", "~> 2.1.9"
    spec.add_development_dependency "ruby-lsp-rspec", "~> 0.1.29"
    spec.add_development_dependency "solargraph", "~> 0.58.3"
  end
  ...
  spec.add_dependency "awrence", "5.0.0"
  ...
  spec.add_dependency "dry-struct", "1.8.1"
  spec.add_dependency "dry-validation", "1.11.1"
  spec.add_dependency "email_address", "0.2.9"
  spec.add_dependency "grape", "3.3.1"
  spec.add_dependency "grape-entity", "1.1.0"
  spec.add_dependency "grape-swagger", "2.1.4"
  spec.add_dependency "grape-swagger-entity", "0.7.1"
  spec.add_dependency "http", "6.0.3"
  spec.add_dependency "jbuilder", "2.15.1"
  ...
  spec.add_dependency "parallel", "2.1.0"
  spec.add_dependency "plissken", "5.0.0"
  spec.add_dependency "public_suffix", "7.0.5"
  ...
  spec.add_dependency "search_cop", "1.5.0"
  spec.add_dependency "semantic_logger", "5.0.0"
  ...
  spec.add_dependency "tilt", "2.7.0"
