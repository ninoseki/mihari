...
Gem::Specification.new do |spec|
  ...
  spec.add_development_dependency "rubocop-factory_bot", "~> 2.27.0"
  spec.add_development_dependency "rubocop-rake", "~> 0.7.1"
  spec.add_development_dependency "rubocop-rspec", "~> 3.5.0"
  spec.add_development_dependency "rubocop-yard", "~> 0.10.0"
  ...
  unless ci_env?
    spec.add_development_dependency "lefthook", "~> 1.11.3"
    spec.add_development_dependency "ruby-lsp-rspec", "~> 0.1.22"
  ...
  spec.add_dependency "dry-monads", "1.7.1"
  spec.add_dependency "dry-schema", "1.14.1"
  spec.add_dependency "dry-struct", "1.8.0"
  spec.add_dependency "dry-validation", "1.11.1"
  spec.add_dependency "email_address", "0.2.5"
  spec.add_dependency "grape", "2.3.0"
  spec.add_dependency "grape-entity", "1.0.1"
  spec.add_dependency "grape-swagger", "2.1.2"
  spec.add_dependency "grape-swagger-entity", "0.5.5"
  spec.add_dependency "http", "5.2.0"
  spec.add_dependency "jbuilder", "2.13.0"
  spec.add_dependency "jr-cli", "0.6.0"
  spec.add_dependency "launchy", "3.1.1"
  spec.add_dependency "memo_wise", "1.11.0"
