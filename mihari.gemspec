...
Gem::Specification.new do |spec|
  ...
  spec.add_development_dependency "standard", "~> 1.39.0"
  ...
  unless ci_env?
    spec.add_development_dependency "lefthook", "~> 1.6.18"
  ...
  spec.add_dependency "grape", "2.1.2"
  ...
  spec.add_dependency "sentry-sidekiq", "~> 5.18.0"
