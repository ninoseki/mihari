...
Gem::Specification.new do |spec|
  ...
  spec.add_development_dependency "standard", "~> 1.43.0"
  ...
  unless ci_env?
    spec.add_development_dependency "lefthook", "~> 1.10.1"
  ...
  spec.add_dependency "dry-monads", "1.7.0"
  spec.add_dependency "dry-schema", "1.14.0"
  spec.add_dependency "dry-struct", "1.7.0"
  spec.add_dependency "dry-validation", "1.11.0"
  spec.add_dependency "email_address", "0.2.4"
  spec.add_dependency "grape", "2.2.0"
  ...
  spec.add_dependency "sentry-sidekiq", "~> 5.22.1"
  ...
  spec.add_dependency "tilt", "2.5.0"
