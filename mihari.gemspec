...
Gem::Specification.new do |spec|
  ...
  spec.add_development_dependency "factory_bot", "~> 6.5.4"
  spec.add_development_dependency "fakefs", "~> 3.0.1"
  ...
  spec.add_development_dependency "rspec-parameterized", "~> 2.0.0"
  ...
  unless ci_env?
    spec.add_development_dependency "lefthook", "~> 1.12.2"
    spec.add_development_dependency "ruby-lsp-rspec", "~> 0.1.22"
    spec.add_development_dependency "solargraph", "~> 0.56.2"
  end
  ...
  spec.add_dependency "jbuilder", "2.14.0"
  ...
  spec.add_dependency "public_suffix", "6.0.2"
  spec.add_dependency "puma", "6.6.1"
  ...
  spec.add_dependency "sentry-sidekiq", "~> 5.26.0"
