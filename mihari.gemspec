...
Gem::Specification.new do |spec|
  ...
  unless ci_env?
    spec.add_development_dependency "lefthook", "~> 1.13.6"
  ...
  spec.add_dependency "puma", "7.0.4"
  ...
  spec.add_dependency "sentry-sidekiq", "5.28.0"
  spec.add_dependency "sidekiq", "8.0.8"
