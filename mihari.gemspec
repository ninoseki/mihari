...
Gem::Specification.new do |spec|
  ...
  spec.add_development_dependency "faker", "~> 3.6.0"
  ...
  spec.add_dependency "dry-schema", "1.15.0"
  spec.add_dependency "dry-struct", "1.8.0"
  spec.add_dependency "dry-validation", "1.11.1"
  spec.add_dependency "email_address", "0.2.8"
  spec.add_dependency "grape", "3.1.1"
  ...
  spec.add_dependency "public_suffix", "7.0.2"
  spec.add_dependency "puma", "7.2.0"
  spec.add_dependency "rack", "3.2.5"
  ...
  spec.add_dependency "sentry-sidekiq", "6.4.0"
  spec.add_dependency "sidekiq", "8.1.1"
