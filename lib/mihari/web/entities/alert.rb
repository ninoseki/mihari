...
module Mihari
  module Entities
    class Alert < Grape::Entity
      ...
      expose :tags, using: Entities::Tag, documentation: { type: Entities::Tag, is_array: true }
    end

    class AlertsWithPagination < Grape::Entity
      expose :alerts, using: Entities::Alert, documentation: { type: Entities::Alert, is_array: true }
