...
RSpec.describe Mihari::Rule do
  ...
  describe ".search" do
    ...
    it do
      alerts = described_class.search(Mihari::Structs::Filters::Rule::SearchFilterWithPagination.new(tag_name: rule.tags.first.name))
    ...
    it do
      alerts = described_class.search(Mihari::Structs::Filters::Rule::SearchFilterWithPagination.new(title: rule.title))
      expect(alerts.length).to eq(1)
    end
    ...
    it do
      alerts = described_class.search(Mihari::Structs::Filters::Rule::SearchFilterWithPagination.new(description: rule.description))
      expect(alerts.length).to eq(1)
    end
  end
  ...
  describe ".count" do
    ...
    it do
      count = described_class.count(Mihari::Structs::Filters::Rule::SearchFilter.new(tag_name: rule.tags.first.name))
    ...
    it do
      count = described_class.count(Mihari::Structs::Filters::Rule::SearchFilter.new(title: rule.title))
      expect(count).to eq(1)
    end
    ...
    it do
      count = described_class.count(Mihari::Structs::Filters::Rule::SearchFilter.new(description: rule.description))
      expect(count).to eq(1)
    end
  end
end
